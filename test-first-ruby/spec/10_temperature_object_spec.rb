...
describe Temperature do
  ...
  describe "utility class methods" do
    describe "fahrenheit to celsius" do
      it "properly converts F to C" do
        Temperature.ftoc(32).should == 0
        Temperature.ftoc(50).should == 10
      end
      it "properly converts C to F" do 
        Temperature.ctof(0) == 32
        Temperature.ctof(50) == 122
      end
    end
  ...
  describe "Temperature subclasses" do
    ...
    describe "Fahrenheit subclass" do
      ...
      it "can call ftoc directly" do 
        Fahrenheit.ftoc(32) == 0
        Fahrenheit.ftoc(112) == 50
      end
    end
  end
