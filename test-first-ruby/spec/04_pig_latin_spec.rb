...
describe "#translate" do
  ...
  it "retains capitalization of the word, capitalziing the first letter of the translated word if the original first letter is moved" do
    s = translate("The quick Brown Fox")
    s.should == "Ethay ickquay Ownbray Oxfay"
  end

  # * retain the punctuation from the original phrase
  it "should retain punctuation from the original phrase" do
    s = translate("The. quick! Brown, Fox;")
    s.should == "Ethay. ickquay! Ownbray, Oxfay;"
  end
